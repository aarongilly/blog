...
![[creations-obsidian-projects-1.png|250]]

# Details
Much better than [[Making an Obsidian Bullet Journal]]. 
...
- Core
	...
	- **[[Auto-Properties Plugin (V1)|Auto-properties]]** - for promoting in-progress tasks to a `next` property automatically
- Optional
