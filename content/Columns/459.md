...
Within an hour it was decided - we were doing it. We were about a month into summer, and some structure and a good challenge was never better timed. Though we've got a few more days to go, now is a good time for me to write this.
...
But it wasn't *perfect*. We did find that **sleep** started to suffer some. In order to get it all done, we had to push back bedtime pretty frequently.
