...
I build systems to solve problems. It's what I do & have done for as long as I can remember. When I learn about a new problem I can't help but immediately start thinking through ways to tackle it. I think about the variables in play, the joints and how they pivot, the factors that cause it and how they could be stopped upstream, the immediate effects and ask myself what 2nd & 3rd order effects could be of whatever the hypothetical course of action is. 

But what if the *system building **is** the problem?*

The **real** problem is that *problems exist* and a completely unavoidable fact of life. Not all problems are solvable. Worst of all, it's in our nature as humans to grow dissatisfied with whatever solutions you do come up with. 
...
But after a while I find myself simply *not* using it. I figure the issue is something inherent to the system design. I migrate tools and start from scratch. I build goals and tasks and projects that all interconnect. I use templates and work the system to a well-honed, perfectly balanced, harmonious coalescence of congruent parts - each dovetailing perfectly into the other. The system stabilizes.

But then time passes, and it turns out still life is *hard*. I forget things or feel overwhelmed. I ask myself "why am I having this type of problem when I have spent so much energy working the system to deliver me from this sort of issue?". 
